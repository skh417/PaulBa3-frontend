                    ...
                    <div className="inputInfoContainer">
                        <div className="inputInfo">
                            <div className="inputIdPw">
                                <input type="text" placeholder="아이디" onChange={this.inputId} />
                                <input type="password" placeholder="비밀번호" onChange={this.inputPw} />
                            </div>
                            <a className="loginBtn" onClick={this.clickLogin}>로그인</a>
                        </div>
                        <div className="saveAndFindInfo">
                            ...
                            <div className="idPwBtn">
                                <a href="https://www.baristapaulbassett.co.kr/member/IdFind.pb">아이디 찾기</a>
                                <a href="https://www.baristapaulbassett.co.kr/member/PwFind.pb">비밀번호 찾기</a>
                            </div>
                        </div>
                    </div>
